...
# Run from the script's folder so config and relative paths resolve correctly.

set -e

# Change to script directory so config file and relative paths (e.g. --data-dir=./prometheus-data) work
